...
from panorama_texture import export_blok_to_texture
...
def main():
    ...
    parser.add_argument("blok_id", type=str, help="The BAG ID of the block on which the panorama is to be projected")
    ...
    export_blok_to_texture(args.pano_id, args.blok_id, args.filename, resolution, height, simplify, force)
